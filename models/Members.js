...
let membersql = {
    ...
    selectOne : ` select userid, name, email, date_format(regdate, "%Y-%m-%d %T") regdate from member where userid = :1 `
};
...
class Member {
    ...
    async selectOne(uid){
        ...
        try{
            ...
            result = await conn.query(membersql.selectOne, params, mariadb.options);
            await conn.commit();
